...
return (<main style={{ display: "grid", placeItems: "center", minHeight: "100vh", background: "#0B1220", color: "#fff" }}><form onSubmit={onLogin} style={{ background: "#111827", padding: 24, borderRadius: 8, width: 360, boxShadow: "0 6px 18px rgba(0,0,0,0.25)" }}><h1 style={{ marginBottom: 12 }}>Legacy Lifespaces CRM</h1>
